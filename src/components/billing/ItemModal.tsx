      ...
      <form onSubmit={submit} className="space-y-4" id="item-form">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <input id="item-pack-size" type="number" inputMode="decimal" min="0" step="any" value={packSize} onChange={(e) => setPackSize(e.target.value)} className={`${inputCls} font-mono`} placeholder="e.g. 6" />
          </div>
          ...
          <div>
            ...
            <input id="item-code" value={code} onChange={(e) => setCode(e.target.value)} className={`${inputCls} font-mono`} placeholder="e.g. DC5" />
          </div>
          <div>
