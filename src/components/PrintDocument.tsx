...
export const PrintDocument: React.FC<PrintDocumentProps> = ({ request, onClose }) => {
  ...
  const content = useMemo(() => {
    ...
    return null;
  }, [request, paper, books, billingReport, financeDoc, dispatches, bookings, customers, suppliers, products, ledger, trucks, settings, quotations, purchaseOrders, returns, invoices, expenses, cashEntries, bankStatementLines, bankReconciliations, cheques]);
