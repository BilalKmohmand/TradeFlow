        ...
        <>
          <div className="flex flex-col sm:flex-row gap-2">
            <div className="relative flex-1 min-w-0">
              ...
              <input value={query} onChange={(e) => setQuery(e.target.value)} placeholder="Search name, ID, phone, city or contact" className={`${inputCls} pl-10`} aria-label="Search suppliers" />
            </div>
