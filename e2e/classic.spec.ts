...
test.describe('Classic menu and reports on desktop', () => {
  test('all 16 classic buttons open something', async ({ page }) => {
    ...
    const checks: [string, () => Promise<void>][] = [
      ...
      ['Account Ledger', () => expect(page.getByRole('tab', { name: 'General ledger', selected: true })).toBeVisible()],
      ...
      ['Vouchers', () => expect(page.getByRole('tab', { name: 'Journal', selected: true })).toBeVisible()],
